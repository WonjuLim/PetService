...
export default function PetRegister() {
  ...
  return (
    <FormStyled>
      ...
      <div>
        <label>매칭날짜</label>
        <input type="date" value={careRequest.startDate}
        onChange={(e) => careRequestChange(e, "startDate")}
        />
        
      </div>
      <div> 
        <label>종료날짜</label>
        <input type="date" value={careRequest.endDate}
        onChange={(e) => careRequestChange(e, "endDate")}
        />
      </div>


      <Button color={"#47B5FF"} title={"등록"} onClick={petRequestInsert} />
      <Button color={"#47B5FF"} title={"취소"} />
    </FormStyled>
  );
}
